-- ============================================================
-- Migration 001 — Schéma initial SESAME
-- Date : 2026-06-03
-- Description : Création de toutes les tables, types et
--               paramètres système de départ
-- ⚠ Ne jamais modifier ce fichier après déploiement en prod
-- ============================================================
...
CREATE TYPE doc_type AS ENUM (
    'carte_identite', 'carte_vtc', 'revtc', 'kbis', 'permis',
    'rir', 'rc_pro', 'rc_circulation', 'carte_grise',
    'certificat_medical', 'photo_profil'
);
